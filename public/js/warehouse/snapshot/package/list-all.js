...
$(document).on('click', '.btn-view-more-package', function () {
  var id = $(this).data('id');
  $.ajax({
    url: '/warehouse/snapshot/package/' + id,
    type: 'get',
...
if (urlPage == "/warehouse/snapshot/package/list") {
  redirectUrl = "/warehouse/snapshot/package/list";
}
