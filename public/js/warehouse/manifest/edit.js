...
$('.add-manifest-form').submit(function (event) {
  ...
  var originalManifestId = $('.originalManifestId').val();
...
manifestInfo = {...manifestInfo,originalManifestId:originalManifestId}
  $.ajax({
    url: '/warehouse/fll/manifest/clone/create',
    type: 'post',
    data: manifestInfo,
    success: function (response) {
      swal({
        ...
        if (response.success == true) {
          window.location.href = '/warehouse/fll/manifest/list';
        }
      })
    }
  })
