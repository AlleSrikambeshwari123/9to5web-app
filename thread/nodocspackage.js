...
var searchData = {customerId:{$ne:null}, createdAt : {"$gte":stdate, "$lte": endate}};
    ...
    PackageHistory.aggregate([
      ...
      csvWriter.writeRecords(records)       // returns a promise
        .then(async() => {  
          ...
          await Mail.sendReportEmail(workerData.email,"NoDocs Report", html);
          console.log(workerData.email);
          var detail = {
            reportType: 'NODOCSPACKAGE',
            dateFrom:stdate,
            dateTo:endate,
            dateRange: daterange,
          ...
          console.log('...Done NODOCSPACKAGE detail');
        });
    })
  })
